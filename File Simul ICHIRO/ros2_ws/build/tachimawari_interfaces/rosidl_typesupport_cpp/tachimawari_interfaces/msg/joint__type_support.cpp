...
static const _Joint_type_support_symbol_names_t _Joint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tachimawari_interfaces, msg, Joint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tachimawari_interfaces, msg, Joint)),
  }
};
...
{
  return &::tachimawari_interfaces::msg::rosidl_typesupport_cpp::Joint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tachimawari_interfaces, msg, Joint)() {
  return get_message_type_support_handle<tachimawari_interfaces::msg::Joint>();
}
