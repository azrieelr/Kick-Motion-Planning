...
static const _Unit_type_support_symbol_names_t _Unit_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, kansei_interfaces, msg, Unit)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, kansei_interfaces, msg, Unit)),
  }
};
...
{
  return &::kansei_interfaces::msg::rosidl_typesupport_cpp::Unit_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, kansei_interfaces, msg, Unit)() {
  return get_message_type_support_handle<kansei_interfaces::msg::Unit>();
}
