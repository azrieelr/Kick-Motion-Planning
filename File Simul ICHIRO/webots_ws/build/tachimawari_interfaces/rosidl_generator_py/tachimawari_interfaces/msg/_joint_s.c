...
bool tachimawari_interfaces__msg__joint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tachimawari_interfaces.msg._joint.Joint", full_classname_dest, 39) == 0);
  }
  tachimawari_interfaces__msg__Joint * ros_message = _ros_message;
  {  // name
...
PyObject * tachimawari_interfaces__msg__joint__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tachimawari_interfaces.msg._joint");
