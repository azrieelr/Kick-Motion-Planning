...
#include "tachimawari_interfaces/msg/detail/joint__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const tachimawari_interfaces::msg::Joint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tachimawari_interfaces::msg::Joint *>(
    untyped_ros_message);
...
{
  return &tachimawari_interfaces::msg::typesupport_fastrtps_cpp::_Joint__handle;
}
